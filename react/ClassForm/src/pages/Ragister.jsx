...
const Ragister = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br pt-20 from-blue-50 to-indigo-100 py-6 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <input
                      ...
                      required
                      className="w-full h-fit px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-500 transition"
                    />
              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-500 transition bg-white"
                  >
              ...
              {/* Submit Button */}
              <div className="flex gap-4 pt-8 border-t-2 border-green-200">
                <button
                  type="submit"
                  className="flex-1 bg-linear-to-r from-green-400 to-green-700 text-white font-bold py-4 px-6 rounded-lg hover:from-green-700 hover:to-green-800 transition duration-300 transform hover:scale-105 shadow-lg"
                >
                  Submit Registration
                </button>
                <button

...
const Home = () => {
  return (
    <section className="min-h-screen flex items-center bg-white px-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center w-full">
        ...
        <div className="space-y-4">
          ...
          <Link to={"Product"}  className="hover:scale-105 mt-6 px-8 py-3 bg-black text-white rounded-xl shadow-lg hover:bg-gray-800 transition duration-300">
            Shop Now
          </Link>
        </div>
